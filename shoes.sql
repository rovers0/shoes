...
CREATE DATABASE IF NOT EXISTS `shoes` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `shoes`;

-- Dumping structure for table shoes.wp_actionscheduler_actions
...
-- Dumping structure for table shoes.wp_actionscheduler_claims
...
-- Dumping structure for table shoes.wp_actionscheduler_groups
...
-- Dumping structure for table shoes.wp_actionscheduler_logs
...
-- Dumping structure for table shoes.wp_commentmeta
...
-- Dumping structure for table shoes.wp_comments
...
-- Dumping structure for table shoes.wp_links
...
-- Dumping structure for table shoes.wp_options
...
) ENGINE=MyISAM AUTO_INCREMENT=501 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci;

-- Data exporting was unselected.

-- Dumping structure for table shoes.wp_postmeta
CREATE TABLE IF NOT EXISTS `wp_postmeta` (
  ...
  KEY `post_id` (`post_id`),
  KEY `meta_key` (`meta_key`(191))
) ENGINE=MyISAM AUTO_INCREMENT=2812 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci;

-- Data exporting was unselected.

-- Dumping structure for table shoes.wp_posts
...
) ENGINE=MyISAM AUTO_INCREMENT=279 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci;

-- Data exporting was unselected.

-- Dumping structure for table shoes.wp_social_users
...
-- Dumping structure for table shoes.wp_termmeta
...
-- Dumping structure for table shoes.wp_terms
...
-- Dumping structure for table shoes.wp_term_relationships
...
-- Dumping structure for table shoes.wp_term_taxonomy
...
-- Dumping structure for table shoes.wp_usermeta
...
-- Dumping structure for table shoes.wp_users
...
-- Dumping structure for table shoes.wp_wc_admin_notes
...
-- Dumping structure for table shoes.wp_wc_admin_note_actions
...
-- Dumping structure for table shoes.wp_wc_category_lookup
...
-- Dumping structure for table shoes.wp_wc_customer_lookup
...
-- Dumping structure for table shoes.wp_wc_download_log
...
-- Dumping structure for table shoes.wp_wc_orders
...
-- Dumping structure for table shoes.wp_wc_orders_meta
...
-- Dumping structure for table shoes.wp_wc_order_addresses
...
-- Dumping structure for table shoes.wp_wc_order_coupon_lookup
...
-- Dumping structure for table shoes.wp_wc_order_operational_data
...
-- Dumping structure for table shoes.wp_wc_order_product_lookup
...
-- Dumping structure for table shoes.wp_wc_order_stats
...
-- Dumping structure for table shoes.wp_wc_order_tax_lookup
...
-- Dumping structure for table shoes.wp_wc_product_attributes_lookup
...
-- Dumping structure for table shoes.wp_wc_product_download_directories
...
-- Dumping structure for table shoes.wp_wc_product_meta_lookup
...
-- Dumping structure for table shoes.wp_wc_rate_limits
...
-- Dumping structure for table shoes.wp_wc_reserved_stock
...
-- Dumping structure for table shoes.wp_wc_tax_rate_classes
...
-- Dumping structure for table shoes.wp_wc_webhooks
...
-- Dumping structure for table shoes.wp_woocommerce_api_keys
...
-- Dumping structure for table shoes.wp_woocommerce_attribute_taxonomies
...
-- Dumping structure for table shoes.wp_woocommerce_downloadable_product_permissions
...
-- Dumping structure for table shoes.wp_woocommerce_log
...
-- Dumping structure for table shoes.wp_woocommerce_order_itemmeta
...
-- Dumping structure for table shoes.wp_woocommerce_order_items
...
-- Dumping structure for table shoes.wp_woocommerce_payment_tokenmeta
...
-- Dumping structure for table shoes.wp_woocommerce_payment_tokens
...
-- Dumping structure for table shoes.wp_woocommerce_sessions
...
-- Dumping structure for table shoes.wp_woocommerce_shipping_zones
...
-- Dumping structure for table shoes.wp_woocommerce_shipping_zone_locations
...
-- Dumping structure for table shoes.wp_woocommerce_shipping_zone_methods
...
-- Dumping structure for table shoes.wp_woocommerce_tax_rates
...
-- Dumping structure for table shoes.wp_woocommerce_tax_rate_locations
